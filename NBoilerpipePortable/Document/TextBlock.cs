...
namespace NBoilerpipePortable.Document
{
	...
	public class TextBlock : ICloneable
	{
		...
		public static readonly NBoilerpipePortable.Document.TextBlock EMPTY_START = new NBoilerpipePortable.Document.TextBlock
			(string.Empty, EMPTY_BITSET, 0, 0, 0, 0, -1);

		public static readonly NBoilerpipePortable.Document.TextBlock EMPTY_END = new NBoilerpipePortable.Document.TextBlock
		...
		/// <seealso cref="NBoilerpipePortable.Labels.DefaultLabels">NBoilerpipePortable.Labels.DefaultLabels
		/// 	</seealso>
